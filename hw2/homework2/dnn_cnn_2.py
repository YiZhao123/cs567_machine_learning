...
def main(main_params):
    ...
    for t in range(num_epoch):
        ...
        for i in range(int(np.floor(N_train / minibatch_size))):
            ...
            # TODO (2)
            tempa2 = model['C2'].forward(m1)
            h2 = model['nonlinear2'].forward(tempa2)
            ...
            grad_tempa2 = model['nonlinear2'].backward(tempa2, grad_h2)
            grad_m1 = model['C2'].backward(m1, grad_tempa2)
            ################################################################################
            #                            End of TODO (3)                                   #
            ################################################################################
